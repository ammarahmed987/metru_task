package com.example.metru.constant

object Constants {

    const val DATABASE_NAME : String = "MY_DB"
    const val PREFERENCES_FILE_NAME : String = "PREFERENCES_FILE_NAME"

    //      COUNTDOWN CONSTANTS
    const val COUNTDOWN_PRIMARY_TIMER_DURATION : Long = 6000
    const val COUNTDOWN_SECONDARY_TIMER_DURATION : Long = 31000
    ...
    //      RECORDING COMPLETED CONSTANTS
    const val REC_COMPLETED_REDO : String = "REC_COMPLETED_REDO"
    const val REC_COMPLETED_RECORDING_URI : String = "REC_COMPLETED_RECORDING_URI"
